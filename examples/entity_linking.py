...
train_data = [
        ("After Destiny's Child's disbanded in 2006, Michelle Williams released her first pop album, Unexpected (2008),", {'id': 'Michelle Williams (musician)'}),
        ("On Broadway, Michelle Williams starred in revivals of the musical Cabaret in 2014 and the drama Blackbird in 2016, for which she received a nomination for the Tony Award for Best Actress in a Play.", {'id': 'Michelle Williams (actor)'}),
